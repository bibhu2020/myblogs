...
export class SeedService implements OnModuleInit {
  ...
  async seed() {
    // Categories
    const aiml      = await this.catRepo.save({ name: 'AI & Machine Learning', slug: 'ai-ml',      description: 'Breakthroughs in artificial intelligence, deep learning, and machine learning research', color: '#3B82F6', icon: '🤖' });
    const travel    = await this.catRepo.save({ name: 'Travel',                 slug: 'travel',     description: 'Adventures, destinations, and educational travel experiences around the world',          color: '#10B981', icon: '✈️' });
    ...
    const quantum   = await this.catRepo.save({ name: 'Quantum Computing',      slug: 'quantum',    description: "Exploring the quantum frontier: qubits, superposition, entanglement, and tomorrow's computers", color: '#7C3AED', icon: '⚛️' });
    const edu       = await this.catRepo.save({ name: 'Educational',            slug: 'educational',description: 'Ideas, mental models, and frameworks for thinking, learning, and understanding our world', color: '#DC2626', icon: '📚' });
    const relativity= await this.catRepo.save({ name: 'Relativity & Spacetime', slug: 'relativity', description: "Einstein's universe: special and general relativity, spacetime, light speed, and cosmic wonders", color: '#1D4ED8', icon: '🌌' });
    ...
    await this.postRepo.save([
      {
        ...
        status: PostStatus.PUBLISHED, authorId: 1, authorName: 'Site Admin',
        readTime: 7, views: 3241, category: edu,
      ...
      },
      {
        ...
        status: PostStatus.PUBLISHED, authorId: 1, authorName: 'Site Admin',
        readTime: 8, views: 2789, category: edu,
      ...
      },
      {
        ...
        status: PostStatus.PUBLISHED, authorId: 1, authorName: 'Site Admin',
        readTime: 9, views: 3890, category: edu,
