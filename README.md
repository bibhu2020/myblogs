...
pinned: false
app_port: 7860
short_description: AI-Powered blogging platform. (self-maintained)
---
...
✓ Publish & manage posts — create, update, delete, and query blog articles with full metadata
✓ User management — create guest authors, update profiles, and manage roles programmatically
✓ Content discovery — list posts, search by keyword or tag, filter by category or date range
✓ Taxonomy control — create and assign categories and tags to organise the content graph
✓ Media operations — upload images and retrieve media records tied to any post
