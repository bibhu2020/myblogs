...
class TestGenerateImage:
    def test_history_category_uses_unsplash_first(self):
        with patch.object(images_mod, "_try_unsplash", return_value=(_noisy_png_bytes(), "image/jpeg", "Credit")) as mock_unsplash:
            result = _generate_image("prompt", category="History", unsplash_query="colosseum rome")
        assert result is not None
        mock_unsplash.assert_called_once()

    def test_history_falls_back_to_ai_when_unsplash_fails(self):
