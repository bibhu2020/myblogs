...
<div role="banner" aria-label="July 2026 sporting events announcement" class="bg-gradient-to-r from-primary-700 to-primary-600 text-white text-center text-sm py-1.5 font-medium">Celebrate Sporting Excellence and Independence!</div>
<!-- HOLIDAY-BANNER-END -->
  </template>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <RouterLink to="/story" @click="mobileOpen=false"
          ...
          :class="layout.variant === 'b' ? 'text-slate-300 hover:text-violet-400 hover:bg-slate-900' : 'text-gray-700 hover:text-primary-600 hover:bg-gray-50'"
        >Story</RouterLink>
        <RouterLink to="/news" @click="mobileOpen=false"
          class="block px-4 py-2.5 font-medium rounded-lg"
          :class="layout.variant === 'b' ? 'text-slate-300 hover:text-violet-400 hover:bg-slate-900' : 'text-gray-700 hover:text-primary-600 hover:bg-gray-50'"
        >News</RouterLink>
