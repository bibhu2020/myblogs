    ...
    inputs: [
      {
        ...
        options: [
          { value: '', label: 'Random' },
          { value: '8-15',  label: 'Ages 8–15' },
          { value: '16-20', label: 'Ages 16–20' },
        ],
      },
      {
        ...
        options: [
          ...
          { value: 'Quantum Adventure',     label: 'Quantum Adventure' },
          { value: 'Relativity & Spacetime',label: 'Relativity & Spacetime' },
          { value: 'Indian Mythology',      label: 'Indian Mythology' },
        ],
      },
    ],
  },
