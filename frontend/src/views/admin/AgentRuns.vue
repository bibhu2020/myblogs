...
const AGENTS = [
    ...
    inputs: [
      {
        ...
        options: [
          { value: '',     label: 'Random' },
          { value: '2-7',  label: 'Ages 2–7 (picture book)' },
          { value: '8-15', label: 'Ages 8–15 (Indian mythology)' },
          { value: '16+',  label: 'Ages 16+ (sci-fi thriller)' },
        ],
      },
      {
        key: 'genre', label: 'Genre', type: 'select', default: '',
        options: [
          { value: '',                         label: 'Random (within age group)' },
          { value: 'Panchatantra Tales',        label: '🐰 Panchatantra Tales (2–7)' },
          { value: 'Popular Cartoon Adventure', label: '📺 Popular Cartoon Adventure (2–7)' },
          { value: 'Superhero Adventure',       label: '🦸 Superhero Adventure (2–7)' },
          { value: 'Indian Mythology',          label: '🙏 Indian Mythology (8–15)' },
          { value: 'Quantum Adventure',         label: '⚛️ Quantum Adventure (16+)' },
          { value: 'Relativity & Spacetime',    label: '🌌 Relativity & Spacetime (16+)' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    inputs: [
      {
        key: 'topic_mode', label: 'Topic', type: 'select', default: '',
        options: [
          { value: '',           label: 'Random (weighted priority pick)' },
