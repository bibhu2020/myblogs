        ...
        <div class="flex items-start justify-between gap-4">
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0"><span class="text-blue-600 font-bold text-sm">{{ comment.authorName.charAt(0) }}</span></div>
              <div>
            ...
            <p v-if="comment.post" class="text-xs text-blue-600 ml-11 mt-1">On: {{ comment.post.title }}</p>
          </div>
